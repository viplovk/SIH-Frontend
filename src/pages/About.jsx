...
export function About() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      {/* Top Banner */}
      <div className="bg-[#101520] border border-white/10 rounded-lg p-6 sm:p-8 relative overflow-hidden">
        <div className="relative z-10 max-w-3xl">
          <div className="flex flex-wrap items-center gap-2 mb-3">
            <span className="font-mono-tech text-xs uppercase px-2.5 py-1 rounded bg-white/[0.06] text-slate-200 border border-white/10 font-semibold">
              SMART INDIA HACKATHON 2026
            </span>
            <span className="font-mono-tech text-xs uppercase px-2.5 py-1 rounded bg-rose-500/10 text-rose-300/90 border border-rose-500/20 font-medium">
              SIH26081
            </span>
            <span className="font-mono-tech text-xs uppercase px-2.5 py-1 rounded bg-white/[0.04] text-slate-300 font-medium">
              THEME: DISASTER MANAGEMENT
            </span>
          </div>

          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-heading font-semibold text-white tracking-tight mb-2">
            Hybrid AI-NWP Multi-Model Forecast Blending System
          </h1>

          <p className="text-slate-400 font-mono-tech text-sm mb-4">
            Team: <strong className="text-white">Algoriot</strong> • Repository: <code className="text-slate-300">viplovk/SIH-Frontend</code>
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-[#101520] border border-white/[0.06] p-5 rounded-lg">
          <div className="w-8 h-8 rounded bg-white/[0.05] border border-white/10 flex items-center justify-center text-slate-300 mb-3">
      ...
      <div className="bg-[#101520] border border-white/10 rounded-lg p-5">
        ...
        <p className="text-xs text-slate-300 leading-relaxed font-sans mb-4">
          The frontend includes a fully abstract API service layer (<code className="text-slate-200">src/api/client.js</code>). When connecting the team's FastAPI / PyTorch inference server, configure the environment variables:
        </p>
        ...
        <div className="bg-[#0b0e14] p-3 rounded font-mono-tech text-xs text-slate-300 space-y-1 mb-4 border border-white/[0.06]">
          ...
          <div><span className="text-slate-300 font-medium">VITE_API_URL</span>=http://localhost:8000/api/v1</div>
          <div><span className="text-slate-300 font-medium">VITE_USE_MOCK_DATA</span>=false</div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs font-mono-tech">
          <div className="bg-[#141a27] p-3 rounded border border-white/[0.04]">
            <span className="text-slate-200 font-semibold block mb-1">GET /api/v1/forecast/point</span>
          ...
          <div className="bg-[#141a27] p-3 rounded border border-white/[0.04]">
            <span className="text-slate-200 font-semibold block mb-1">GET /api/v1/models/metrics</span>
