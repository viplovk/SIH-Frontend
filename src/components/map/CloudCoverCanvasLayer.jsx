// Algoriot Real Continuous Cloud Cover Density Field
...
export function CloudCoverCanvasLayer({
  ...
  useEffect(() => {
    ...
    canvas.className = "algoriot-cloud-canvas";
    ...
    const render = () => {
      ...
      try {
        const grid = getOrBuildSpatialGrid(stations, "clouds", frameIndex);
        if (!grid) return;
