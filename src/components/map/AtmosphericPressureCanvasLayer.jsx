// Algoriot Real Continuous Atmospheric Surface Pressure Field
// Evaluated from Open-Meteo Operational Forecasts (hPa)
...
export function AtmosphericPressureCanvasLayer({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      try {
        const grid = getOrBuildSpatialGrid(stations, "pressure", frameIndex);
        if (!grid) return;
