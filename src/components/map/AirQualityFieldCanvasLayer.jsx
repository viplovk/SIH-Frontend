...
export function AirQualityFieldCanvasLayer({
  ...
  useEffect(() => {
    ...
    // Create Canvas inside Leaflet map container
    ...
    const render = () => {
      ...
      try {
        const grid = getOrBuildSpatialGrid(stations, "aqi", frameIndex);
        if (!grid) return;
